...
unset CDPATH
TEGONAL_GITHUB_COMMONS_LATEST_VERSION="v1.1.0"
...
function cleanupOnPushToMain() {
	...
	replacePlaceholdersCodeOfConduct_Tegonal "$projectDir/.github/CODE_OF_CONDUCT.md" || die "could not fill the placeholders of code of conduct template"
	replacePlaceholdersContributorsAgreement_Tegonal "$projectDir/.github/Contributor Agreement.txt" "github-commons" || die "could not fill the placeholders of contributors agreement template"
